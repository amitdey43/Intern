...
// --- Main Chat Component ---
export const Usermentorchat = () => {
  let { userId, mentorId }= useParams()
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center space-x-4">
            <div className="relative">
              <img
                src="https://placehold.co/48x48/E2E8F0/4A5568?text=M"
                alt="Mentor Avatar"
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800">Chat with Mentor</h1>
        ...
        <div className="container mx-auto">
          <form onSubmit={handleSendMessage} className="flex items-center space-x-3">
            <input
              ...
              className="flex-1 w-full px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              autoComplete="off"
            />
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white rounded-full p-3 flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
